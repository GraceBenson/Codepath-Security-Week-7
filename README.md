...
1) Rename an image to have the following name <i m g src=a onerror=alert(document.cookie)>.jpg
...
Steps in order to recreate:
1) Find/create a file and name it Dinosaurs secret life<i m g src=x onerror=alert(1)>.png
